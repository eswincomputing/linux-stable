...
#define RKMODULE_CAMERA_MODULE_INDEX	"eswin,camera-module-index"
#define RKMODULE_CAMERA_MODULE_FACING	"eswin,camera-module-facing"
#define RKMODULE_CAMERA_MODULE_NAME	"eswin,camera-module-name"
#define RKMODULE_CAMERA_LENS_NAME	"eswin,camera-module-lens-name"

#define RKMODULE_CAMERA_SYNC_MODE	"eswin,camera-module-sync-mode"
