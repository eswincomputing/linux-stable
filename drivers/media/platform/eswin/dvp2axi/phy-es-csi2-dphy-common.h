...
/*
 * ESWIN DVP2AXI csi-dphy-common driver
 *
 ...
 */
 ...
 #ifndef _PHY_ESWIN_CSI2_DPHY_COMMON_H_
 #define _PHY_ESWIN_CSI2_DPHY_COMMON_H_
 ...
 struct csi2_dphy {
     ...
     void *phy_hw[ESMODULE_MULTI_DEV_NUM];
     bool is_streaming;
     int lane_mode;
 ...
 int es_csi2_dphy_hw_init(void);
 int es_csi2_dphy_init(void);
