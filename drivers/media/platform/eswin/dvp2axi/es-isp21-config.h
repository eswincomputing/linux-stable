 ...
 */
 ...
 #ifndef _UAPI_ES_ISP21_CONFIG_H
 #define _UAPI_ES_ISP21_CONFIG_H
 
 #include <linux/const.h>
 #include <linux/types.h>
 #include <linux/v4l2-controls.h>
 #include "es-isp2-config.h"
 ...
 /**
  * struct esisp_isp21_stat_buffer - ESWIN ISP2 Statistics Meta Data
  *
  * @meas_type: measurement types (CIFISP_STAT_ definitions)
  * @frame_id: frame ID for sync
  * @params: statistics data
  */
 struct esisp_isp21_stat_buffer {
