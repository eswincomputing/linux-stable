 ...
 */
 ...
 #include "es-isp3-config.h"
 
 #define RKISP_CMD_GET_TB_HEAD_V32 \
     _IOR('V', BASE_VIDIOC_PRIVATE + 12, struct esisp32_thunderboot_resmem_head)
 ...
 /**
  * struct esisp32_isp_stat_buffer - ESWIN ISP32 Statistics Meta Data
  *
  * @meas_type: measurement types (ISP3X_STAT_ definitions)
  * @frame_id: frame ID for sync
  * @params: statistics data
  */
 struct esisp32_isp_stat_buffer {
 ...
 struct esisp32_thunderboot_resmem_head {
     struct esisp_thunderboot_resmem_head head;
 ...
 struct esisp32_lite_stat_buffer {
