 ...
 */
 ...
 #ifndef _UAPI_ES_ISP3_CONFIG_H
 #define _UAPI_ES_ISP3_CONFIG_H
 ...
 /**
  * struct esisp3x_isp_stat_buffer - Rockchip ISP3 Statistics Meta Data
  *
  * @meas_type: measurement types (ISP3X_STAT_ definitions)
  * @frame_id: frame ID for sync
  * @params: statistics data
  */
 struct esisp3x_isp_stat_buffer {
     __u32 meas_type;
     __u32 frame_id;
     __u32 params_id;
